    ...
    .then(info => {
        ...
        for (let i = 0 ; i < data.length; i++) {
            ...
            if(data[i] != data[7]){
                ...
                img.className = 'weapon_card_img'
                div_cards.className = 'cards_weapons' //le agrego una clase al div card
...
div.className = 'div_weapons' //le asigno una clase a ese div
div.innerHTML = weapons; //*el contenido de ese div va a ser lo que haya adentro de la constante characters, en este caso estarian todas las cards que cree con el fetch
