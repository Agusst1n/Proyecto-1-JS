...
.   then(res => res.json())
    ...
    div.className = 'div_mapas' //le asigno una clase a ese div
    div.innerHTML = mapas; //*el contenido de ese div va a ser lo que haya adentro de la constante characters, en este caso estarian todas las cards que cree con el fetch
